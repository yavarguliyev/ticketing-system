...
export class TicketsController {
  ...
  @ApiOperation({ summary: 'Book tickets with READ UNCOMMITTED isolation' })
  @ApiParam({ name: 'id', description: 'The ID of the ticket to book' })
  @ApiResponse({ status: 200, description: 'Tickets successfully booked.', type: Ticket })
  @ApiResponse({ status: 404, description: 'Ticket not found.' })
  @ApiResponse({ status: 409, description: 'Not enough tickets available.' })
  @MediumRateLimit()
  @Post(':id/book-read-uncommitted')
  ...
  @ApiOperation({ summary: 'Book tickets with READ COMMITTED isolation' })
  @ApiParam({ name: 'id', description: 'The ID of the ticket to book' })
  @ApiResponse({ status: 200, description: 'Tickets successfully booked.', type: Ticket })
  @ApiResponse({ status: 404, description: 'Ticket not found.' })
  @ApiResponse({ status: 409, description: 'Not enough tickets available.' })
  @MediumRateLimit()
  @Post(':id/book-read-committed')
  ...
  @ApiOperation({ summary: 'Book tickets with REPEATABLE READ isolation' })
  @ApiParam({ name: 'id', description: 'The ID of the ticket to book' })
  @ApiResponse({ status: 200, description: 'Tickets successfully booked.', type: Ticket })
  @ApiResponse({ status: 404, description: 'Ticket not found.' })
  @ApiResponse({ status: 409, description: 'Not enough tickets available.' })
  @MediumRateLimit()
  @Post(':id/book-repeatable-read')
  ...
  @ApiOperation({ summary: 'Book tickets with SERIALIZABLE isolation' })
  @ApiParam({ name: 'id', description: 'The ID of the ticket to book' })
  @ApiResponse({ status: 200, description: 'Tickets successfully booked.', type: Ticket })
  @ApiResponse({ status: 404, description: 'Ticket not found.' })
  @ApiResponse({ status: 409, description: 'Not enough tickets available.' })
  @MediumRateLimit()
  @Post(':id/book-serializable')
  ...
  @ApiOperation({ summary: 'Test isolation level anomalies' })
  @ApiParam({ name: 'id', description: 'The ID of the ticket to test with' })
  @ApiResponse({ status: 200, description: 'Test results for different anomalies' })
  @ApiResponse({ status: 404, description: 'Ticket not found.' })
  @MediumRateLimit()
  @Get(':id/test-isolation-anomalies')
